...
typedef enum  {	intKERNEL, intGPIO, intTMR0LP, intTMR1LP, intUART0, intUART1, intLINK0, intLINK1, intNAND = 10, intMIL0, intMIL1,
				intDIGC, intDMA0, intDMA1, intDMA2, intDMA3, intARINC_RX, intARINC_TX = 20, intDMA4 = 22, intDMA5, intDMA6, intDMA7,
				intDMA8 = 29, intDMA9, intDMA10, intDMA11, intUPDOWN0, intUPDOWN1, intUPDOWN2, intUPDOWN3, intDMA12, intDMA13, intLCD,
				intIRQ0 = 41, intIRQ1, intIRQ2, intIRQ3, intSPI, intSSI0, intSSI1, intVIRPT, intVCAM, intBUSLK, intH264, intTMR0HP,
				intTMR1HP, intALARM, intTIC, intWDOG, intHW} InterruptRequest_type;
